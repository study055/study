...
{
#if defined(IMX175_MIPI_RAW_2LANE)
	RAW_INFO(IMX175_2LANE_SENSOR_ID, SENSOR_DRVNAME_IMX175_MIPI_RAW_2LANE,NULL), 
#endif
...
#endif
#if defined(GC0329_RAW)
	RAW_INFO(GC0329_SENSOR_ID, SENSOR_DRVNAME_GC0329_RAW, NULL),
#endif
#if defined(SP0838_YUV)
	YUV_INFO(SP0838_SUB_SENSOR_ID, SENSOR_DRVNAME_SP0838_YUV, NULL),
#endif
    ...
    YUV_INFO(SP0A19_YUV_SENSOR_ID, SENSOR_DRVNAME_SP0A19_YUV,NULL), 
		...
		RAW_INFO(IMX179_2lane_SENSOR_ID, SENSOR_DRVNAME_IMX179_MIPI_RAW_2LANE,NULL), 
#endif
