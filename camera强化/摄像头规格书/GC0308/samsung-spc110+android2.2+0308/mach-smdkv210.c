...
#include <media/ov7675_platform.h>
...
#ifdef CONFIG_VIDEO_OV7675
#define OV7675_ENABLED
#endif
...
#ifdef OV7675_ENABLED
static struct ov7675_platform_data ov7675_plat = {
	.default_width = 640,
	.default_height = 480,
	.pixelformat = V4L2_PIX_FMT_YUYV,
	.freq = 24000000,
...
static struct i2c_board_info ov7675_i2c_info = {
	I2C_BOARD_INFO("OV7675", 0x78 >> 1),
	.platform_data = &ov7675_plat,
};

static struct s3c_platform_camera ov7675 = {
//#ifdef CAM_ITU_CH_A
	.id		= CAMERA_PAR_A,
//#else
//	.id		= CAMERA_PAR_B,
...
#elif defined(GC0308_ENABLED)
	.default_cam	= CAMERA_PAR_A,
#elif defined(OV7675_ENABLED)
	.default_cam	= CAMERA_PAR_A,
