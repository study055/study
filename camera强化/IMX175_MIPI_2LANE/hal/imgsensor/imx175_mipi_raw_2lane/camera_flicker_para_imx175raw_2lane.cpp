...
static void get_flicker_para_by_ZSD(FLICKER_CUST_PARA* para)
{
  ...
  FLICKER_CUST_STATISTICS EV60_L50 = {1451, 402, 1062, -446};
  FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
...
{
  int i;
  int freq[9] =  { 70, 80, 100, 120, 130, 160, 170, 190, 210};
  FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
  FLICKER_CUST_STATISTICS EV50_L60 = {1116, 416, 777, -394};
  FLICKER_CUST_STATISTICS EV60_L50 = {1331, 438, 1157, -468};
  FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
