...
static int count=0;
    ...
    if (On) {
		...
		if (currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX179_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX219_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX175_MIPI_RAW_2LANE,currSensorName))))			  
		  {
		 ...
		 else if (currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX179_MIPI_RAW_2LANE,currSensorName))))		  
		  {
			if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_A_SUB, VOL_2800,mode_name))
			{
			PK_DBG("[CAMERA SENSOR] Fail to enable analog power\n");
			//return -EIO;
			//goto _kdCISModulePowerOn_exit_;
			...
			//DOVDD
			PK_DBG("[ON_general 1.8V]sensorIdx:%d \n",SensorIdx);
			if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_D2_SUB, VOL_1800,mode_name))
			{
				PK_DBG("[CAMERA SENSOR] Fail to enable digital power\n");
				//return -EIO;
				//goto _kdCISModulePowerOn_exit_;
			...
			mdelay(10);
			//AF_VCC
			if(TRUE != hwPowerOn(CAMERA_POWER_VCAM_A2_SUB, VOL_2800,mode_name))
			{
				PK_DBG("[CAMERA SENSOR] Fail to enable analog power\n");
				//return -EIO;
				goto _kdCISModulePowerOn_exit_;
		...
		if (currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX179_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX219_MIPI_RAW,currSensorName))||(0 == strcmp(SENSOR_DRVNAME_IMX175_MIPI_RAW_2LANE,currSensorName))))	
		...
		else if (currSensorName && ((0 == strcmp(SENSOR_DRVNAME_IMX179_MIPI_RAW_2LANE,currSensorName))))	
		 {
			...
			mdelay(1);
			if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_A_SUB, mode_name)) {
			PK_DBG("[CAMERA SENSOR] Fail to OFF digital power\n");
			//return -EIO;
			goto _kdCISModulePowerOn_exit_;
			}
			mdelay(1);
			if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_D2_SUB,mode_name)) {
			PK_DBG("[CAMERA SENSOR] Fail to OFF analog power\n");
			//return -EIO;
			goto _kdCISModulePowerOn_exit_;
			}
			if(TRUE != hwPowerDown(CAMERA_POWER_VCAM_A2_SUB,mode_name))
			{
			PK_DBG("[CAMERA SENSOR] Fail to enable analog power\n");
			//return -EIO;
			goto _kdCISModulePowerOn_exit_;
